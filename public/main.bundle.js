...
var ProfileComponent = (function () {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getProfile().subscribe(function (profile) {
...
var RegisterComponent = (function () {
    function RegisterComponent(service, authService, _flashMessagesService, router) {
        this.service = service;
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        var _this = this;
        this._flashMessagesService.show('We are in about component!', { cssClass: 'alert-danger', timeout: 1000 });
        var user = {
            name: this.name,
            email: this.email,
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this._flashMessagesService.show('You are now registered and can login now.', { cssClass: 'alert-success', timeout: 1000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this._flashMessagesService.show('You are now registered and can login now.', { cssClass: 'alert-danger', timeout: 1000 });
...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1> MEAN Authentication App</h1>\n  <p class=\"lead\">Welcome to our custom MEAN authentication></p>\n  <div>\n    <a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a>&nbsp;<a class=\"btn btn-default\" [routerLink]=\"['/login']\">Login</a>\n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-md-4\">\n    <h3>Express Backend</h3>\n    <p></p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3> Angular-CLI</h3>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>JWT Tokens </h3>\n  </div>\n</div>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_home_home_component__ = __webpack_require__(97);
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (res) {
            ...
            if (res.success) {
                ...
                _this._flashMessagesService.show(res.msg, { cssClass: 'alert-danger', timeout: 5000 });
                _this.router.navigate(['login']);
            }
        });
    };
